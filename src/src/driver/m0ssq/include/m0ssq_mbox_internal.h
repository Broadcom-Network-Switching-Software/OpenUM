...
#ifndef M0SSQ_MBOX_INTERNAL_H
#define M0SSQ_MBOX_INTERNAL_H
 ...
 */
typedef struct m0ssq_mbox_int_msg_s {
...
typedef struct mbox_s {
    ...
    m0ssq_fifo_t chan[MBOX_CHN_TYPE_MAX];
    ...
    m0ssq_mbox_msg_handler_f recv_msg_handler;
 ...
 */
typedef struct m0ssq_mbox_dev_s {
 ...
 * \retval SYS_ERR_XXX if the mbox driver is not avaiable.
 */
extern int
 ...
 *
 * \retval SYS_OK No errors.
 * \retval SYS_ERR_XXX MBOX driver initialization failed.
 */
extern int
 ...
 *
 * \retval SYS_OK No errors.
 * \retval SYS_ERR_XXX MBOX driver cleanup failed.
 */
extern int
m0ssq_mbox_cleanup(int unit);

#endif /* M0SSQ_MBOX_INTERNAL_H */
