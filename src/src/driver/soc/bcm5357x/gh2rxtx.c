...
uint32 _PCI_TO_PTR(void * x) {       
    if ((uint32)x >= 0x2000000) {
       return (uint32) x;
    } else if ((uint32)x >= 0x1040000) {
...
/* Forwards */
static void bcm5357x_rx_direct(void);
static void bcm5357x_rx_refill(void);
static void bcm5357x_rx_retrieve(soc_rx_packet_t *pkt);
static void bcm5357x_rxtx_task(void *data);
static sys_error_t bcm5357x_tx_internal(soc_tx_packet_t *pkt);


static void
bcm5357x_rx_direct(void)
{
...
APISTATIC void
bcm5357x_rx_refill(void)
{
    uint8 i;
    uint8 unit = 0;
    CMIC_CMC1_DMA_DESCr_t cmic_cmc1_dma_desc;
    CMIC_CMC1_CHX_DMA_CTRLr_t cmic_cmc1_chx_dma_ctrl;    
    for(i=0; i<SOC_MAX_RX_BUF_POSTED; i++) {
        if (rx_pkt_valid[i]) {
            ...
            if (RX_PKT_AVAILABLE(pkt)) {
                ...
                CMIC_CMC1_DMA_DESCr_CLR(cmic_cmc1_dma_desc);
                CMIC_CMC1_DMA_DESCr_ADDRf_SET(cmic_cmc1_dma_desc, PTR_TO_PCI(rx_dcb));
                WRITE_CMIC_CMC1_DMA_DESCr(unit, RX_CH1, cmic_cmc1_dma_desc);

                READ_CMIC_CMC1_CHX_DMA_CTRLr(unit, RX_CH1, cmic_cmc1_chx_dma_ctrl);
                CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 1);
                WRITE_CMIC_CMC1_CHX_DMA_CTRLr(unit, RX_CH1, cmic_cmc1_chx_dma_ctrl);
                return;
            }
        }
    }
...
APISTATIC void
bcm5357x_rx_retrieve(soc_rx_packet_t *pkt)
{
...
APISTATIC void
bcm5357x_rxtx_task(void* data)
{


    CMIC_CMC1_DMA_STATr_t cmic_cmc1_dma_stat;
    CMIC_CMC1_CHX_DMA_CTRLr_t cmic_cmc1_chx_dma_ctrl;
    CMIC_CMC1_DMA_STAT_CLRr_t cmic_cmc1_dma_stat_clr;

    READ_CMIC_CMC1_DMA_STATr(0, cmic_cmc1_dma_stat);
    /* RX polling mode */
    if (rx_pkt_in_dma != NULL) {
        if (CMIC_CMC1_DMA_STATr_CH1_CHAIN_DONEf_GET(cmic_cmc1_dma_stat)) {

            /* Clear bits. */
            READ_CMIC_CMC1_CHX_DMA_CTRLr(0, RX_CH1, cmic_cmc1_chx_dma_ctrl);
            CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 0);
            WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, RX_CH1, cmic_cmc1_chx_dma_ctrl);

            READ_CMIC_CMC1_DMA_STAT_CLRr(0,  cmic_cmc1_dma_stat_clr);
            CMIC_CMC1_DMA_STAT_CLRr_CH1_DESCRD_CMPLT_CLRf_SET(cmic_cmc1_dma_stat_clr, 1);
            WRITE_CMIC_CMC1_DMA_STAT_CLRr(0,  cmic_cmc1_dma_stat_clr);
            READ_CMIC_CMC1_DMA_STATr(0, cmic_cmc1_dma_stat);            
    ...
    if (tx_pkt_in_dma != NULL) {
        soc_tx_packet_t *pkt;
        if (CMIC_CMC1_DMA_STATr_CH0_CHAIN_DONEf_GET(cmic_cmc1_dma_stat)) {
            /* Clear bits. */
            READ_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
            CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 0);
            WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
            
            READ_CMIC_CMC1_DMA_STAT_CLRr(0,  cmic_cmc1_dma_stat_clr);
            CMIC_CMC1_DMA_STAT_CLRr_CH0_DESCRD_CMPLT_CLRf_SET(cmic_cmc1_dma_stat_clr, 1);
            WRITE_CMIC_CMC1_DMA_STAT_CLRr(0,  cmic_cmc1_dma_stat_clr);
            ...
            if (CMIC_CMC1_DMA_STATr_CH0_DMA_ACTIVEf_GET(cmic_cmc1_dma_stat)) {            
                /* Abort TX DMA since it has something wrong */
                int i;
                READ_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
                CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 1);
                WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
                CMIC_CMC1_CHX_DMA_CTRLr_ABORT_DMAf_SET(cmic_cmc1_chx_dma_ctrl, 1);                
                WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
                ...
                /* Restore value */
                CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 0);
                CMIC_CMC1_CHX_DMA_CTRLr_ABORT_DMAf_SET(cmic_cmc1_chx_dma_ctrl, 0);                
                WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, TX_CH, cmic_cmc1_chx_dma_ctrl);
...
bcm5357x_rxtx_stop(void)
{
    ...
    READ_CMIC_CMC1_CHX_DMA_CTRLr(0, RX_CH1, cmic_cmc1_chx_dma_ctrl);
    READ_CMIC_CMC1_DMA_STATr(0, cmic_cmc1_dma_stat);
    if (CMIC_CMC1_DMA_STATr_CH1_DMA_ACTIVEf_GET(cmic_cmc1_dma_stat)) {
        CMIC_CMC1_CHX_DMA_CTRLr_DMA_ENf_SET(cmic_cmc1_chx_dma_ctrl, 1);
        WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, RX_CH1, cmic_cmc1_chx_dma_ctrl);
        CMIC_CMC1_CHX_DMA_CTRLr_ABORT_DMAf_SET(cmic_cmc1_chx_dma_ctrl, 1);
        WRITE_CMIC_CMC1_CHX_DMA_CTRLr(0, RX_CH1, cmic_cmc1_chx_dma_ctrl);
...
bcm5357x_rxtx_init(void)
{
    ...
    CMIC_CMC1_HOSTMEM_ADDR_REMAP_0r_t cmic_cmc1_hostmem_addr_remap_0;
    CMIC_CMC1_HOSTMEM_ADDR_REMAP_1r_t cmic_cmc1_hostmem_addr_remap_1;
    CMIC_CMC1_HOSTMEM_ADDR_REMAP_2r_t cmic_cmc1_hostmem_addr_remap_2;    
    CMIC_CMC1_HOSTMEM_ADDR_REMAP_3r_t cmic_cmc1_hostmem_addr_remap_3;        
#endif    
    CMIC_CMC1_CHX_DMA_CTRLr_t cmic_cmc1_chx_dma_ctrl;
    CMIC_RXBUF_EPINTF_RELEASE_ALL_CREDITSr_t cmic_rxbuf_epintf_release_all_credits;    
    CMIC_CMC1_CH1_COS_CTRL_RX_0r_t cmic_cmc1_ch1_cos_ctrl_rx_0;
    EPC_LINK_BMAP_LO_64r_t epc_link_bmap_lo_64;
    ...
    CMIC_CMC1_HOSTMEM_ADDR_REMAP_0r_SET(cmic_cmc1_hostmem_addr_remap_0, 0x144d2450);
    WRITE_CMIC_CMC1_HOSTMEM_ADDR_REMAP_0r(unit, cmic_cmc1_hostmem_addr_remap_0);

    CMIC_CMC1_HOSTMEM_ADDR_REMAP_1r_SET(cmic_cmc1_hostmem_addr_remap_1, 0x19617595);
    WRITE_CMIC_CMC1_HOSTMEM_ADDR_REMAP_1r(unit, cmic_cmc1_hostmem_addr_remap_1);

    CMIC_CMC1_HOSTMEM_ADDR_REMAP_2r_SET(cmic_cmc1_hostmem_addr_remap_2, 0x1e75c6da);
    WRITE_CMIC_CMC1_HOSTMEM_ADDR_REMAP_2r(unit, cmic_cmc1_hostmem_addr_remap_2);

    CMIC_CMC1_HOSTMEM_ADDR_REMAP_3r_SET(cmic_cmc1_hostmem_addr_remap_3, 0x1f);
    WRITE_CMIC_CMC1_HOSTMEM_ADDR_REMAP_3r(unit, cmic_cmc1_hostmem_addr_remap_3);
#endif

    CMIC_CMC1_CHX_DMA_CTRLr_CLR(cmic_cmc1_chx_dma_ctrl);
    CMIC_CMC1_CHX_DMA_CTRLr_PKTDMA_ENDIANESSf_SET(cmic_cmc1_chx_dma_ctrl, CFG_LITTLE_ENDIAN ? 0 : 1);
    CMIC_CMC1_CHX_DMA_CTRLr_DIRECTIONf_SET(cmic_cmc1_chx_dma_ctrl, 1);    
    WRITE_CMIC_CMC1_CHX_DMA_CTRLr(unit, TX_CH, cmic_cmc1_chx_dma_ctrl);
    
    CMIC_CMC1_CHX_DMA_CTRLr_DIRECTIONf_SET(cmic_cmc1_chx_dma_ctrl, 0);    
    WRITE_CMIC_CMC1_CHX_DMA_CTRLr(unit, RX_CH1, cmic_cmc1_chx_dma_ctrl);    
    ...
    CMIC_CMC1_CH1_COS_CTRL_RX_0r_CLR(cmic_cmc1_ch1_cos_ctrl_rx_0);
    CMIC_CMC1_CH1_COS_CTRL_RX_0r_COS_BMPf_SET(cmic_cmc1_ch1_cos_ctrl_rx_0, 0xFF);
    WRITE_CMIC_CMC1_CH1_COS_CTRL_RX_0r(unit, cmic_cmc1_ch1_cos_ctrl_rx_0);
    ...
    task_add(bcm5357x_rxtx_task, (void *)NULL);
...
bcm5357x_tx_internal(soc_tx_packet_t *pkt)
{
    int i;
    uint32 port;
    ...
    if (PBMP_NOT_NULL(pkt->port_bitmap)) {
        ...
        /* Use SOBMH mode. */
        for (port = BCM5357X_LPORT_MIN; port <= BCM5357X_LPORT_MAX; port++) {
            if (PBMP_MEMBER(pkt->port_bitmap, port)) {
                break;
            }
        }

        if (port > BCM5357X_PORT_MAX) {
        ...
        TX_DCB_SOBMH_COSf_SET((*tx_dcb), 0x7);
    ...
    CMIC_CMC1_DMA_DESCr_CLR(cmic_cmc1_dma_desc);
    CMIC_CMC1_DMA_DESCr_ADDRf_SET(cmic_cmc1_dma_desc, PTR_TO_PCI(tx_dcb));
    WRITE_CMIC_CMC1_DMA_DESCr(0, TX_CH, cmic_cmc1_dma_desc);
...
sys_error_t
bcm5357x_tx(uint8 unit, soc_tx_packet_t *pkt)
{
...
sys_error_t
bcm5357x_rx_set_handler(uint8 unit, SOC_RX_HANDLER fn, BOOL intr)
{
    if (fn == NULL || unit > 0) {
...
sys_error_t
bcm5357x_rx_fill_buffer(uint8 unit, soc_rx_packet_t *pkt)
{
    uint8 i;
    ...
    for(i=0; i<SOC_MAX_RX_BUF_POSTED; i++) {
        if (rx_pkt_valid[i] == FALSE) {
            ...
            if (rx_pkt_in_dma == NULL) {
                ...
                CMIC_CMC1_DMA_DESCr_CLR(cmic_cmc1_dma_desc);
                CMIC_CMC1_DMA_DESCr_ADDRf_SET(cmic_cmc1_dma_desc, PTR_TO_PCI(rx_dcb));
                WRITE_CMIC_CMC1_DMA_DESCr(0, RX_CH1, cmic_cmc1_dma_desc);
