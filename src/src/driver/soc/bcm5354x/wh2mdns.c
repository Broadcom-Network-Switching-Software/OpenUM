 ...
 */
sys_error_t
bcm5354x_mdns_enable_set(uint8 unit, BOOL mdns_enable)
{
    ...
    if (mdns_enable) {
        ...
        FP_TCAMm_F2_0_L4_DST_MASKf_SET(fp_tcam, 0xFFFFFFFF);
 ...
 */
sys_error_t
bcm5354x_mdns_enable_get(uint8 unit, BOOL *mdns_enable)
{
    FP_TCAMm_t fp_tcam;
