...
#define CDK_XGSM_MIIM_IS_IBUS(phy_addr)      ((phy_addr & 0x200) != 0)
#define CDK_XGSM_MIIM_BUS_NUM_GET(phy_addr)  (phy_addr >> 6)
#define CDK_XGSM_MIIM_PHY_ID_GET(phy_addr)   (phy_addr & CDK_XGSM_MIIM_PHY_ID)
...
/* MII write access. */
extern int 
cdk_xgsm_miim_write(int unit, uint32 phy_addr, uint32 reg, uint32 val); 

/* MII read access. */
extern int
cdk_xgsm_miim_read(int unit, uint32 phy_addr, uint32 reg, uint32 *val); 

/* MII write access to internal SerDes PHY registers. */
extern int 
cdk_xgsm_miim_iblk_write(int unit, uint32 phy_addr, uint32 reg, uint32 val); 

/* MII read access to internal SerDes PHY registers. */
extern int
cdk_xgsm_miim_iblk_read(int unit, uint32 phy_addr, uint32 reg, uint32 *val); 

extern int
cdk_xgsm_sbus_read(int unit, uint32 phy_addr, uint32 phy_reg, uint32 *phy_data);

extern int
cdk_xgsm_sbus_write(int unit, uint32 phy_addr, uint32 phy_reg, uint32 phy_data);
