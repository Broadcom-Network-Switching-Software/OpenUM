/*
 * $Id: unimac.c,v 1.8 Broadcom SDK $
 *
...
mac_uni_init(int unit, uint8 lport)
{
    ...
    TX_IPG_LENGTHr_TX_IPG_LENGTH_FLDf_SET(tx_ipg_length, 12);
...
mac_uni_ipg_update(int unit, int lport)
{
    ...
    if (fd) {
       ...
       /*
            ...
            */
       TX_IPG_LENGTHr_CLR(tx_ipg_length);
       TX_IPG_LENGTHr_TX_IPG_LENGTH_FLDf_SET(tx_ipg_length, ipg);
       WRITE_TX_IPG_LENGTHr(unit, lport, tx_ipg_length);
...
mac_uni_loopback_set(int unit, uint8 lport, int lb)
{
    ...
    if (pcm_phyctrl_phy_get_driver_name(unit, lport, 0) == NULL &&
        ...
        lb != 0) 
    {
      /* FL's QTCE ports need phy linkup signal to active MAC loopback */
                    ...
                    int value)
{
    ...
    switch(type) {
        ...
        case SOC_MAC_CONTROL_PFC_XOFF_TIME:
        {
            ...
            PFC_XOFF_TIMERr_PFC_XOFF_TIMER_FLDf_SET(mac_xoff_timer, value);
        ...
        case SOC_MAC_CONTROL_EEE_TX_WAKE_TIME:
        {
            ...
            MII_EEE_WAKE_TIMERr_MII_EEE_WAKE_TIMER_FLDf_SET(mii_eee_wake_timer, value);
            ...
            GMII_EEE_WAKE_TIMERr_GMII_EEE_WAKE_TIMER_FLDf_SET(gmii_eee_wake_timer, value);
                    ...
                    int *value)
{
    ...
    switch (type) {
        ...
        case SOC_MAC_CONTROL_TIMESTAMP_TRANSMIT:
        {
             ...
             *value = (int) TX_TS_DATAr_TX_TS_DATA_FLDf_GET(tx_ts_data);
             break;
        }
        case SOC_MAC_CONTROL_PFC_TYPE:
        {
        ...
        case SOC_MAC_CONTROL_PFC_REFRESH_TIME:
        {
            ...
            *value = PFC_XOFF_TIMERr_PFC_XOFF_TIMER_FLDf_GET(pfc_xoff_timer);
            break;
        }
        case SOC_MAC_CONTROL_PFC_XOFF_TIME:
        {
        ...
        case SOC_MAC_CONTROL_EEE_TX_WAKE_TIME:
        {
            MII_EEE_WAKE_TIMERr_t mii_eee_wake_timer;
            SOC_IF_ERROR_RETURN(READ_MII_EEE_WAKE_TIMERr(unit, lport, mii_eee_wake_timer));
            *value = MII_EEE_WAKE_TIMERr_MII_EEE_WAKE_TIMER_FLDf_GET(mii_eee_wake_timer);
            break;
        }
                ...
                soc_port_duplex_t  duplex, int *ifg)
{
    ...
    SOC_IF_ERROR_RETURN(READ_TX_IPG_LENGTHr(unit, lport, tx_ipg_length));
    ipg = TX_IPG_LENGTHr_TX_IPG_LENGTH_FLDf_GET(tx_ipg_length);
