/*
 * $Id: flvlan.c,v 1.1 Broadcom SDK $
 *
...
static vlan_type_t fl_vlan_type = VT_COUNT;

/*
 *  Function : bcm5607x_pvlan_egress_set
 *
 *  Purpose :
...
/*
 *  Function : bcm5607x_pvlan_egress_get
 *
 *  Purpose :
 ...
 */
sys_error_t
bcm5607x_pvlan_egress_get(uint8 unit, uint8 lport, pbmp_t *lpbmp)
{
    sys_error_t rv = SYS_OK;
    EGR_MASKm_t egr_mask;
...
sys_error_t
bcm5607x_qvlan_port_get(uint8 unit, uint16  vlan_id, pbmp_t *lpbmp, pbmp_t *tag_lpbmp)
{
    sys_error_t rv = SYS_OK;
    VLANm_t vlan;
    EGR_VLANm_t egr_vlan;
 ...
 */
sys_error_t
bcm5607x_vlan_create(uint8 unit, vlan_type_t type, uint16  vlan_id)
{
    sys_error_t rv = SYS_OK;
    VLANm_t vlan;
    EGR_VLANm_t egr_vlan;
...
/*
 *  Function : _bcm5607x_vlan_destroy
 *
 *  Purpose :
 *      Destroy vlan.
 *
 ...
 */
sys_error_t
bcm5607x_vlan_destroy(uint8 unit, uint16  vlan_id)
{
    sys_error_t rv;
    VLANm_t vlan;
    EGR_VLANm_t egr_vlan;
...
/*
 *  Function : bcm5607x_vlan_type_set
 *
 *  Purpose :
 ...
 */
sys_error_t
bcm5607x_vlan_type_set(uint8 unit, vlan_type_t type)
{
    int i;
 ...
 */
sys_error_t
bcm5607x_vlan_reset(uint8 unit)
{
    sys_error_t rv = SYS_OK;
    int lport;
    VLANm_t vlan;
    ...
    EGR_VLANm_CLR(egr_vlan);
    EGR_VLANm_UT_BITMAPf_SET(egr_vlan, SOC_PBMP(BCM5607X_ALL_PORTS_MASK));
