...
/*  
*   When CFG_IP_FRAGMENT_INCLUDED, the max. of HTTPD_MSS would be "CFG_UIP_HTTPD_MSS(default:1456)*CFG_IP_FRAGMENT_PACKET".
*   This the the max. size for one-time transmission before fragmentation.
*/
#define HTTPD_SHARED_BUF_SIZE   (CFG_UIP_HTTPD_MSS*CFG_IP_FRAGMENT_PACKET)
#else
