...
SSP_HANDLER_RETVAL ssphandler_shift_right_cgi(SSP_HANDLER_CONTEXT *cxt, SSP_PSMH psmem) REENTRANT;
SSP_HANDLER_RETVAL ssphandler_shift_left_cgi(SSP_HANDLER_CONTEXT *cxt, SSP_PSMH psmem) REENTRANT;
...
/*  Port Status Web Page */
    ...
    { "shift_right.cgi", ssphandler_shift_right_cgi, sspfile_top_right_htm, SSPF_QUERY_STRINGS_H, SSP_BANK4 },    
    { "shift_left.cgi", ssphandler_shift_left_cgi, sspfile_top_right_htm, SSPF_QUERY_STRINGS_H, SSP_BANK4 },    
