...
$(CFETARGET) : $(CRT0OBJS) $(BSPOBJS) $(LIBCFE) $(LIBPHYECD)  $(LDSCRIPT)
	$(GLD) -o $(CFETARGET) -Map $(CFETARGET).map $(LDFLAGS) --defsym reset_addr=$(CFG_TEXT_START) -T $(BSP_SRC)/$(LD_SCRIPT) $(CRT0OBJS) --start-group $(BSPOBJS) $(SDKLIBS) -L. -lcfe -L$(LIB_PATH) $(LDLIBS) --end-group
