...
//#define CFG_IP_FRAGMENT_INCLUDED            (1)
#ifdef CFG_IP_FRAGMENT_INCLUDED
//#define CFG_IP_FRAGMENT_PACKET              (1)
#define CFG_IP_FRAGMENT_PACKET              (2)
//#define CFG_IP_FRAGMENT_PACKET              (3)

/*  CFG_UIP_HTTPD_MSS must a multiple of 8; default value is 1400. 
*   The value of 1460 can make the largest packet length of 1514 in a single packet.
*   In IP fragmentation, we choose 1456 here.
*/
#define CFG_UIP_HTTPD_MSS                       (1456)  
#endif
