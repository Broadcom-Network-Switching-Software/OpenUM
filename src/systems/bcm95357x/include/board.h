...
#define BOARD_FIRMWARE_ADDR            (0xF0600000)

/* Frimware address to program */
#define BOARD_SECONDARY_FIRMWARE_ADDR  (0xF0C00000)
...
/* Factory Address */
#define CFG_FACTORY_CONFIG_BASE        (0xF00FB000)
#define CFG_FACTORY_CONFIG_OFFSET      (0x0)
/* Config address */
#define CFG_CONFIG_BASE                (0xF00F9000)
#define CFG_CONFIG_OFFSET              (0x000)
#define CFG_CONFIG_SIZE                (0x2000 - CFG_CONFIG_OFFSET)
/* Persistence address */
#define MEDIUM_FLASH_START_ADDRESS     (0xF00FC000)
#define MEDIUM_FLASH_SIZE              (0x4000)
#else
/* FLASH base address */
#define CFG_FLASH_START_ADDRESS        (0xF0000000)

/* Factory Address */
#define CFG_FACTORY_CONFIG_BASE        (0xF05FB000)
#define CFG_FACTORY_CONFIG_OFFSET      (0x0)
/* Config address */
#define CFG_CONFIG_BASE                (0xF05F9000)
#define CFG_CONFIG_OFFSET              (0x000)
#define CFG_CONFIG_SIZE                (0x2000 - CFG_CONFIG_OFFSET)

/* Persistence address */
#define MEDIUM_FLASH_START_ADDRESS     (0xF05FC000)
#define MEDIUM_FLASH_SIZE              (0x4000)
#endif

/* Shortcut TX/RX for boot loader */
#define BOOT_SOC_INCLUDE_FILE          "soc/bcm5357x.h"
#define BOOT_FUNC_TX                    bcm5357x_tx
#define BOOT_FUNC_RX_SET_HANDLER        bcm5357x_rx_set_handler
#define BOOT_FUNC_RX_FILL_BUFFER        bcm5357x_rx_fill_buffer
