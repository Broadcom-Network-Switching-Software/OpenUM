...
SWITCHOBJ = gh2mdns.o gh2rxtx.o gh2loop.o gh2vlan.o gh2port.o gh2linkscan.o gh2led.o gh2lag.o gh2access.o gh2switch.o unimac.o xlmac.o clmac.o \
            gh2blocks.o gh2portconf.o  gh2pcm.o \
            set_tdm.o tdm_gh2_filter.o\
            tdm_gh2_llist.o tdm_gh2_main.o\
            tdm_gh2_parse.o tdm_gh2_proc.o tdm_gh2_scan.o\
            tdm_gh2_shim.o tdm_gh2_chk_tdm.o tdm_filter.o tdm_llist.o\
            tdm_main.o tdm_math.o tdm_ovsb.o\
            tdm_parse.o tdm_proc.o tdm_scan.o\
            tdm_tsfm.o tdm_ver.o tdm_vmap.o

ifeq ($(strip ${CFG_GH2_SOC_DEBUG}), 1)
SWITCHOBJ += gh2debug.o
endif
# Add PCM Support
...
-include $(wildcard $(patsubst %.o, %.d, $(BSPOBJS) $(ALLOBJS)))
