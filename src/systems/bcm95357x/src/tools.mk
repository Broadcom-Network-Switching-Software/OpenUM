...
ifeq ($(strip ${CFG_GNU_TOOLCHAIN}),1)
CFLAGS += -g -std=gnu99 -Wunused -Wall -ffunction-sections -fdata-sections -msoft-float -mtpcs-frame -m$(ENDIAN)-endian -fno-builtin -fms-extensions -DTOOLCHAIN_gnu
else
