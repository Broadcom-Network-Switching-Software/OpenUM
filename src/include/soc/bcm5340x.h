...
#define R_PER_PORT_AGE_CONTROL       10,0x02000500
...
extern sys_error_t bcm5340x_l2_op(uint8 unit, l2x_entry_t *entry, uint8 op, uint16 *index);
...
#define TSCE_NUM_OF_CORES        6
/* TSC0, TSC1, TSC2, TSC3, TSC4, TSC5(TSC0Q)  */
