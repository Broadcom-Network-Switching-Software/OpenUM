#ifndef _BCM5352X_DRV_H_
#define _BCM5352X_DRV_H_
...
#define   SOC_F_RESET              (SOC_F_ATTACHED|SOC_F_INITED|SOC_F_POLLED|SOC_F_HW_RESETING|SOC_F_KNET_MODE)
    ...
    soc_portctrl_functions_t *soc_portctrl_functions;
    /* Feature cache */
    uint32    features[64];
} soc_control_t;


#define SOC_UNIT_NAME(unit) "BCM53570_A0"

#define SOC_UNIT_GROUP(unit) "BCM53570"
