...
extern sys_error_t bcm5346x_l2_op(uint8 unit, l2x_entry_t *entry, uint8 op, uint16 *index);
...
#define TSCE_NUM_OF_CORES        2
/* TSC0, TSC1 */
#define TSCE_CORE_NUM_GET(lport) ((SOC_PORT_L2P_MAPPING(lport) - PHY_XLPORT0_BASE) / 4)

#define VIPER_NUM_OF_CORES        1
/* VIPER */
#define VIPER_CORE_NUM_GET(lport) ((SOC_PORT_L2P_MAPPING(lport) - PHY_MXQPORT0_BASE) / 4)
