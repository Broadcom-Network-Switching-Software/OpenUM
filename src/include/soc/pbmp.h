...
/* Port PBMP operators */
#define _SHR_PBMP_PTR(bm) \
	&(_SHR_PBMP_WORD_GET(bm,_SHR_PBMP_WENT(0)))
...
#define PBMP_PORT_MAX       _SHR_PBMP_PORT_MAX 

#define PBMP_CLEAR(pbm)     _SHR_PBMP_CLEAR(pbm) 
#define PBMP_MEMBER(bmp, port)  _SHR_PBMP_MEMBER((bmp), (port)) 
#define PBMP_ITER(bmp, port)  _SHR_PBMP_ITER((bmp), (port)) 
#define PBMP_COUNT(pbm, count)  _SHR_PBMP_COUNT(pbm, count) 

#define PBMP_IS_NULL(pbm)   _SHR_PBMP_IS_NULL(pbm) 
#define PBMP_NOT_NULL(pbm)  _SHR_PBMP_NOT_NULL(pbm) 
#define PBMP_EQ(pbm_a, pbm_b)  _SHR_PBMP_EQ(pbm_a, pbm_b) 
#define PBMP_NEQ(pbm_a, pbm_b)  _SHR_PBMP_NEQ(pbm_a, pbm_b) 
#define PBMP(pbm_a)            _SHR_PBMP(pbm_a)
/* Assignment operators */
#define PBMP_ASSIGN(dst, src)  _SHR_PBMP_ASSIGN(dst, src) 
#define PBMP_AND(pbm_a, pbm_b)  _SHR_PBMP_AND(pbm_a, pbm_b) 
#define PBMP_OR(pbm_a, pbm_b)  _SHR_PBMP_OR(pbm_a, pbm_b) 
#define PBMP_XOR(pbm_a, pbm_b)  _SHR_PBMP_XOR(pbm_a, pbm_b) 
#define PBMP_REMOVE(pbm_a, pbm_b)  _SHR_PBMP_REMOVE(pbm_a, pbm_b) 
#define PBMP_NEGATE(pbm_a, pbm_b)  _SHR_PBMP_NEGATE(pbm_a, pbm_b) 
#define PBMP_ENTRY(pbm_a, port)  _SHR_PBMP_ENTRY(pbm_a, port)
#define PBMP_PTR(pbm_a0)             _SHR_PBMP_PTR(pbm_a0)
#define PBMP_WORD_GET(pbm_a0, word)        _SHR_PBMP_WORD_GET(pbm_a0, word)
#define PBMP_WORD_SET(pbm_a0, word, val)        _SHR_PBMP_WORD_SET(pbm_a0, word, val)
#define PBMP_CAST(val)                  (*((pbmp_t *) &val))
/* Port PBMP operators */
#define PBMP_PORT_SET(pbm, port)  _SHR_PBMP_PORT_SET(pbm, port) 
#define PBMP_PORT_ADD(pbm, port)  _SHR_PBMP_PORT_ADD(pbm, port) 
#define PBMP_PORT_REMOVE(pbm, port)  _SHR_PBMP_PORT_REMOVE(pbm, port) 
#define PBMP_PORT_FLIP(pbm, port)  _SHR_PBMP_PORT_FLIP(pbm, port) 
